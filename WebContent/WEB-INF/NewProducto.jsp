...
<body>
	  ...
	  <form class="row g-3" action="abmcProductos" method="get">
 		...
 		<%/* <div class="col-12">
  		...
  		<div class="col-12">
    		<label for="inputAddress2" class="form-label">IdCategoria</label>
    		<input type="text" class="form-control" id="idCategoria" name="idCategoria" placeholder="Ingrese categoria" required>
  		</div>
  		...
  		<div class="col-12">
  		 ...
  		 <div class="col-12">
    		...
    		<input type="text" class="form-control" id="stock" name="stock" placeholder="Ingrese stock" required>
  		</div>
