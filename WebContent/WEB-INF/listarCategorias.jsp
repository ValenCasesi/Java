...
<body>
  ...
  <path
				...
				<ul class="navbar-nav justify-content-center ">
					<li class="navbar-item ">CATEGORIAS</li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="d-grid gap-2 d-md-block">
		<a href="abmcCategorias?accion=add"><button type="button"
				class="btn btn-light">
				AGREGAR
	...
	<table class="table table-light table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><a
					href="abmcCategorias?accion=editar
  ...
  <path fill-rule="evenodd"
				...
				<td><a
					href="abmcCategorias?accion=borrar&idCategoria=<%=cat.getIdCategoria()%>">
