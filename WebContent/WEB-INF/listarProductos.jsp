...
<body>
  ...
  <path
				...
				<ul class="navbar-nav justify-content-center ">
					<li class="navbar-item ">PRODUCTOS</li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="d-grid gap-2 d-md-block">
		<a href="abmcProductos?accion=add"><button type="button"
				class="btn btn-light">
				AGREGAR
	...
	<table class="table table-light table-striped">
		...
		<tbody>
			...
			<tr class="table-active">
				...
				<td><%=Prod.getStock()%></td>
				<td><%=Prod.getCat().getIdCategoria()%></td>
				<td><a
					href="abmcProductos?accion=editar
						&idProducto=<%=Prod.getIdProducto()%>
						&idCategoria=<%=Prod.getCat().getIdCategoria()%>
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
				...
				<td><a
					href="abmcProductos?accion=borrar&idProducto=<%=Prod.getIdProducto()%>"><button
